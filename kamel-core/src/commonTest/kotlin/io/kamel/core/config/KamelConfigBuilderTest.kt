...
class KamelConfigBuilderTest {
    ...
    fun testAddStringMapper() {
        ...
        assertTrue { builder.mappers[String::class]!!.contains<Mapper<*, *>>(StringMapper) }
    }
    ...
    fun testAdd_URL_Mapper() {
        ...
        assertTrue { builder.mappers[URL::class]!!.contains<Mapper<*, *>>(URLMapper) }
    }
    ...
    fun testAdd_URI_Mapper() {
        ...
        assertTrue { builder.mappers[URI::class]!!.contains<Mapper<*, *>>(URIMapper) }
    }
